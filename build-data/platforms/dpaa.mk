...
vpp_cmake_args += -DCMAKE_TOOLCHAIN_FILE=$(PACKAGE_BUILD_DIR)/../../../toolchain.cmake -DCMAKE_C_FLAGS="-g -Ofast -fPIC -march=$(MARCH) -ftls-model=local-dynamic -Wno-error=unused-value -I$(EXTRA_INC) \
