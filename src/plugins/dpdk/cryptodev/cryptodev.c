			  ...
			  u32 aad_len)
{
  ...
  rte_cryptodev_sym_session_opaque_data_set(sessions[CRYPTODEV_OP_TYPE_ENCRYPT],
					    aad_len);
  rte_cryptodev_sym_session_opaque_data_set(sessions[CRYPTODEV_OP_TYPE_DECRYPT],
					    aad_len);
  CLIB_MEMORY_STORE_BARRIER ();
